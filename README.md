...
CAS **EC-15 전자저울**의 RS-232 데이터를 USB-RS232 변환기를 통해 읽고, 안정 중량을 ROS 2 topic으로 발행하는 Python / ROS 2 도구입니다.
...
| node | `ec15_weight_node` | 안정 중량 publisher |
...
│   ├── ros2_node.py         # 안정 중량 ROS 2 publisher
